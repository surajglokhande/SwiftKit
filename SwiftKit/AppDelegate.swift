...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        Stripe.setDefaultPublishableKey("pk_test_R0wcCRRtZxmDCKFwC2qtFm51")
    ...
    func logUser() {
        ...
        Crashlytics.sharedInstance().setUserEmail("suraj.lokhande@fabric.io")
        Crashlytics.sharedInstance().setUserIdentifier("29101990")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SwiftKit")
